...
def app():
    ...
    st.markdown("### Select the index col or leave empty if none")
    
    #slider to decide index col
    #index_col = st.number_input("Type index col for dataframe: (-1 indicates no index has been choosen)", step =1, value = -1)
